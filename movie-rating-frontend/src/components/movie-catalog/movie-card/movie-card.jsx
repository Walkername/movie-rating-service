...
function MovieCard({ movie, index }) {
    ...
    const getBadgeType = () => {
        ...
        if (new Date(movie.createdAt) > new Date(Date.now() - 7 * 24 * 60 * 60 * 1000)) return "new";
        return null;
    };
            ...
            <div className="movie-card__poster">
                {movie.posterPicUrl ? (
                    ...
                    <div className="movie-card__poster-placeholder">
                        <span className="movie-card__poster-text">{movie.title}</span>
                    </div>
                )}
            </div>
            ...
            <div className="movie-card__content">
                ...
                {genres.length > 0 && (
                    <div className="movie-card__genres">
                        ...
                        {genres.length > 3 && (
                            <span className="movie-card__genre">+{genres.length - 3}</span>
                        )}
                    </div>
                )}
            </div>
