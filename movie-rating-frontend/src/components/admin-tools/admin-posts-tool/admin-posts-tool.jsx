                ...
                <div className="markdown-help">
                    <details>
                        ...
                        <div className="help-grid">
                            ...
                            <div><code># Header 1</code> → <h1 style={{display: 'inline', fontSize: '1.2em'}}>Header 1</h1></div>
                            <div><code>## Header 2</code> → <h2 style={{display: 'inline', fontSize: '1.1em'}}>Header 2</h2></div>
                            <div><code>[link](url)</code> → <a href="#" style={{pointerEvents: 'none'}}>link</a></div>
                        </div>
                    </details>
                </div>
