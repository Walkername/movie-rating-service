...
function UserData({ isAccessToEdit, user, handleEdit, currentUserId = null }) {
    ...
    return (
        <div className="user-profile">
                ...
                <div className="user-profile__content">
                    <div className="user-profile__header">
                        <h1 className="user-profile__username">
                            {user.username}
                            <span className="user-profile__user-id">
                                #{user.id}
                            </span>
                        </h1>
                    ...
                    <div className="user-profile__info">
                        <div className="user-profile__section">
                            ...
                            <p
                                className={`user-profile__section-text ${!user.description ? "user-profile__section-text--empty" : ""}`}
                            >
                                {user.description ||
            ...
            <div className="user-profile__divider-container">
                <hr className="user-profile__divider" />
            </div>

            <div className="user-profile__photos-section">
                <PhotoPreviewStrip
            ...
            <div className="user-profile__rated-movies-section">
