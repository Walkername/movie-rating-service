...
export default function UserPhotoCatalog() {
    ...
    const fetchUserData = useCallback(() => {
        getUser(id)
            .then((data) => {
                setUserData(data);
                downloadFile(data.profilePicId).then((url) => {
                ...
                <div className="user-photos__card">
                    <div className="user-photos__header">
                        ...
                        <p className="user-photos__subtitle">
                            Photos uploaded by{" "}
                            <span className="user-photos__username">
                                {getUserDisplayName()}
                            </span>
                        </p>
                    </div>
                    ...
                    {userData && (
                        <div className="user-photos__user-info">
                            <img
                                ...
                                onError={(e) => {
                                    e.target.src =
                                        "https://via.placeholder.com/80/0088a3/ffffff?text=" +
                                        (userData.username?.charAt(0) || "U");
                                }}
                            />
                            <div className="user-photos__user-details">
                                <h2 className="user-photos__user-name">
                                    {getUserDisplayName()}
                                </h2>
                                {userData.bio && (
                                    <p className="user-photos__user-bio">
                                        {userData.bio}
                                    </p>
                                )}
                            </div>
                    ...
                    {isLoading ? (
                        ...
                        <div className="user-photos__empty">
                            ...
                            <h3 className="user-photos__empty-title">
                                No Photos Yet
                            </h3>
